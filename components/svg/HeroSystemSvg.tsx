...
export function HeroSystemSvg() {
  return (
    <div className="w-full bg-[#FFFEFA] border border-[rgba(10,39,71,0.14)] rounded-lg p-5 sm:p-6 shadow-xs text-[#0A2747]">
      {/* Card Header */}
      ...
      {/* Full-width Responsive Flow Grid (5 Columns on Desktop) */}
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1.1fr_auto_1.4fr] gap-3.5 items-center">
        {/* Node 1: User Input */}
        <div className="p-4 rounded bg-[#F6F3EC] border border-[rgba(10,39,71,0.12)] space-y-1">
        ...
        <div className="p-4 rounded bg-[#FFFEFA] border-2 border-[#B98945] shadow-xs space-y-1">

  ...
  return (
    <div className="w-full bg-[#FFFEFA] border border-[rgba(10,39,71,0.14)] rounded-lg p-5 sm:p-6 shadow-xs space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-[rgba(10,39,71,0.08)]">
        <div>
          <span className="font-mono text-[11px] text-[#7C3AED] font-semibold tracking-wider uppercase block">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded bg-[#7C3AED]/5 border-2 border-[#7C3AED]/30 space-y-3">
          <div className="flex items-center justify-between border-b border-[#7C3AED]/20 pb-2">
            ...
            <span className="text-[10px] font-mono text-[#7C3AED]">Web Crypto API</span>
          </div>

          <div className="space-y-2 text-xs">
            <div className="p-2.5 rounded bg-[#FFFEFA] border border-[#7C3AED]/20 text-[#0A2747]">
        ...
        <div className="p-4 rounded bg-[#F6F3EC] border border-[rgba(10,39,71,0.12)] space-y-3">
          <div className="flex items-center justify-between border-b border-[rgba(10,39,71,0.10)] pb-2">
            ...
            <span className="text-[10px] font-mono text-[#5A738E]">Ciphertext Only</span>
          </div>

          <div className="space-y-2 text-xs">
            <div className="p-2.5 rounded bg-[#FFFEFA] border border-[rgba(10,39,71,0.08)] text-[#0A2747]">
